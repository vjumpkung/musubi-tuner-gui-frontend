import FramepackModelLoader from './model_specific/framepack/framepack_model_loader'
...
const FramepackTrainer = () => (
    <div className="flex flex-col gap-3 m-3">
        <Typography variant="h1" className="ml-5">
            Framepack Train Network LoRA
        </Typography>
        <div className="flex flex-col gap-3 mb-5">
            <FramepackModelLoader />
            <TrainingOutput />
            <LoRANetwork />
            <Optimizer />
            <LearningRate />
...
export default FramepackTrainer
